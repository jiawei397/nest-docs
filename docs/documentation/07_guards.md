...
:::info
守卫在所有中间件之后执行，但在任何拦截器（详见下章《[Interceptors](https://www.yuque.com/jiqingyun-begup/yimxc4/ybe02phl3256gimi)》）之前执行。
:::
...
此外，useClass并不是处理自定义提供程序注册的唯一方法。在[这里](https://www.yuque.com/jiqingyun-begup/yimxc4/cythiv1zfxpmx8hy)了解更多。
:::
